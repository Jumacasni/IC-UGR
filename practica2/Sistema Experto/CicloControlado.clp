...
(defrule Actualizar-Hora
   ...
   (assert (modulo persona_no_se_ha_movido))
   (assert (modulo persona_no_ha_ido_banio))
   (assert (modulo persona_varias_veces_banio))
   (assert (modulo asistenta_llega_tarde))
   (assert (modulo persona_no_se_ha_dormido))
   (assert (modulo persona_inactiva))
   (assert (modulo persona_realiza_mas_desplazamientos))
 )
